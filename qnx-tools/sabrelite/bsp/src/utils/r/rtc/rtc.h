...
extern int init_at91rtc(struct chip_loc *chip, char *argv[]);
extern int get_at91rtc(struct tm *tm, int cent_reg);
extern int set_at91rtc(struct tm *tm, int cent_reg);
...
extern int init_mx51srtc(struct chip_loc *chip, char *argv[]);
extern int get_mx51srtc(struct tm *tm, int cent_reg);
extern int set_mx51srtc(struct tm *tm, int cent_reg);
...
__SRCVERSION( "$URL: http://svn/product/branches/6.5.0/trunk/utils/r/rtc/rtc.h $ $Rev: 754094 $" )
