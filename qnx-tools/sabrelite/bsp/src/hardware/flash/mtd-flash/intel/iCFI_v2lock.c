 ...
 * Description
 *
 * Use this for Intel flash capable of block locking.
 */

int f3s_iCFI_v2lock(f3s_dbase_t *dbase,
                    f3s_access_t *access,
                    uint32_t flags,
                    uint32_t offset)
{
	...
	send_command(memory, INTEL_LOCK);
...
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/flash/mtd-flash/intel/iCFI_v2lock.c $ $Rev: 710521 $")
#endif
