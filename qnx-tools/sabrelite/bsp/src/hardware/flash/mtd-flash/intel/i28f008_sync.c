 ...
 * This is the only MTDv1 API for uniform block flash.
 */

int32_t f3s_i28f008_sync(f3s_dbase_t *dbase,
                         f3s_access_t *access,
                         uint32_t flags,
                         uint32_t offset,
                         int32_t size)
...
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/flash/mtd-flash/intel/i28f008_sync.c $ $Rev: 710521 $")
#endif
