 ...
 * Description
 *
 * This is the only MTDv1 erase function for Intel flash.
 */

void f3s_i28f008_resume(f3s_dbase_t *dbase,
                        f3s_access_t *access,
                        uint32_t flags,
                        uint32_t offset)
{
...
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/flash/mtd-flash/intel/i28f008_resume.c $ $Rev: 710521 $")
#endif
