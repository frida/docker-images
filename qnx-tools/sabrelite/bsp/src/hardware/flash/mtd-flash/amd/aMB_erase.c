...
void f3s_aMB_erase(f3s_dbase_t *dbase,
                   f3s_access_t *access,
                   uint32_t flags,
                   uint32_t offset,
                   int32_t size)
{
	...
	f3s_aMB_v2erase(dbase, access, flags, offset);
}
...
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/flash/mtd-flash/amd/aMB_erase.c $ $Rev: 710521 $")
#endif
