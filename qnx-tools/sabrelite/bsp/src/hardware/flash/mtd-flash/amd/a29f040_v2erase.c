...
int f3s_a29f040_v2erase(f3s_dbase_t *dbase,
                        f3s_access_t *access,
                        uint32_t flags,
                        uint32_t offset)
{
	...
	/* The command address is always 16-bits */
	amd_cmd1 = AMD_CMD_ADDR1_W16 * flashcfg.bus_width;
	amd_cmd2 = AMD_CMD_ADDR2_W16 * flashcfg.bus_width;
...
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/flash/mtd-flash/amd/a29f040_v2erase.c $ $Rev: 710521 $")
#endif
