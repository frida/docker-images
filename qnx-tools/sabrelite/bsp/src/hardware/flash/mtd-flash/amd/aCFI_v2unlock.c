 ...
 * Description
 *
 * Use this for spansion flash capable of block locking.  This code
 * makes use of the DYB volatile lock bits.
 */

int f3s_aCFI_v2unlock(f3s_dbase_t *dbase,
                    f3s_access_t *access,
                    uint32_t flags,
                    uint32_t offset)
{
	...
	send_command(memory, AMD_DYB_CLEAR);
...
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/flash/mtd-flash/amd/aCFI_v2unlock.c $ $Rev: 710521 $")
#endif
