...
VALUE(SP_QTIME,			offsetof(struct syspage_entry, qtime));
...
/* __SRCVERSION("asmoff.h $Rev: 751784 $"); */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/startup/lib/asmoff.h $ $Rev: 751784 $")
#endif
