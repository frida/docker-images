...
/* SRC */
#define MX51_SRC_BASE                       0x73FD0000
#define	MX51_SRC_SIZE	                    0x4000
#define MX51_SRC_SRC                        0x00
    #define SRC_warm_reset_enable           (1<<0)
    #define SRC_sw_gpu_rst                  (1<<1)
    #define SRC_sw_vpu_rst                  (1<<2)
    #define SRC_sw_ipu_rst                  (1<<3)
    #define SRC_sw_open_vg_rst              (1<<4)
    #define SRC_warm_rst_bypass_count_16    (1<<5)
    #define SRC_warm_rst_bypass_count_32    (2<<5)
    #define SRC_warm_rst_bypass_count_64    (3<<5)
    #define SRC_mask_wdog_rst_msk           (0x5<<7)
    #define SRC_mask_wdog_rst_nmsk          (0xA<<7)
     
#define MX51_SRC_SRSR                       0x08
    #define SRC_SRSR_WDOG_RST_B             (1<<4)


#endif	/* __ARM_MX51_H_INCLUDED */

/* __SRCVERSION("mx51.h $Rev: 731468 $"); */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/startup/lib/public/arm/mx51.h $ $Rev: 731468 $")
#endif
