...
#ifndef __AM335X_SK_H_INCLUDED
#define __AM335X_SK_H_INCLUDED
...
{
	bb_not_detected	= 0,
	bb_AM335X_SK	= 1,		/* AM335X_SK Base Board */
	bb_unknown		= 99,
};
...
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/startup/lib/public/arm/am335x-starter-kit.h $ $Rev: 729039 $")
#endif
