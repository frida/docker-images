...
#define	ARM_MAP_SYSPAGE_RO	0xfffffffe	/* flags to arm_map() for read-only syspage/cpupage */
#define ARM_MAP_NOEXEC	0x80000000		/* flags to arm_map() for I/O mem */
#define ARM_MAP_DEVICE  0x40000000		/* flags to arm_map() for I/O device */
...
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/startup/lib/arm/cpu_startup.h $ $Rev: 756641 $")
#endif
