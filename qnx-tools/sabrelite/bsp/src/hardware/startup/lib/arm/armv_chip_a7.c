 ...
 *
 *       We also need to explicibtly specify ARM_MMU_CR_XP even though that
...
__SRCVERSION("$URL: http://svn/product/branches/6.5.0/trunk/hardware/startup/lib/arm/armv_chip_a7.c $ $Rev: 756641 $")
#endif
